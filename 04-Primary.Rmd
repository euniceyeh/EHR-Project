...
Because the anova test yields that glm3 is better, our final model is `glm3` with two variables: total staffed beds and gross patient revenue. Here is a table of odds ratios with 95% CI.
```{r}
